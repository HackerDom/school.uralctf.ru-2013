...
class Migration(SchemaMigration):
    ...
    models = {
        u'_project_.stageuser': {
            ...
            'anketa': ('django.db.models.fields.BooleanField',
                       [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField',
                    [], {'primary_key': 'True'}),
            'task_1': ('django.db.models.fields.BooleanField', [],
                       {'default': 'False'}),
            'task_2': ('django.db.models.fields.BooleanField',
                       [], {'default': 'False'}),
